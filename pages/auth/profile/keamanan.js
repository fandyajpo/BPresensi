      ...
      <div className="pt-20 px-4 bg-custom-pewter h-screen w-full">
        <div className="space-y-4">
          <div className="space-y-6 w-full">
            <div className="flex flex-row items-center w-full bg-white gap-2 px-4 py-2 rounded-full">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5"
          ...
          <div className="space-y-4">
            <div>
              <button className="bg-custom-green shadow-custom-green shadow-md rounded-full w-36">
