...
const EditProfile = () => {
  ...
  const handleOpenChangePhoto = () => setChangePhoto(true);
        ...
        <div className="px-4 space-y-4">
          <div className="w-full h-full flex items-center justify-center border rounded-md p-4 bg-white">
            <div className="flex flex-col items-center justify-center gap-4">
              <div className="bg-gray-500 w-24 h-24 rounded-xl" />
              <div className="relative w-full h-full flex justify-center items-center">
                <div className="absolute bottom-4 bg-white w-24 h-6 flex items-center justify-center bg-opacity-30">
                  <button onClick={handleOpenChangePhoto}>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      className="h-6 w-6"
                      fill="none"
