...
const Capture = () => {
  ...
  return (
    <div className='w-full h-full'>
      ...
      >
        <div className='bg-white h-72 w-72 flex items-center justify-center rounded-xl'>
          <p className='font-bold text-md'>{err}</p>
        </div>
      </animated.div>
      <div
        className={` ${
      ...
      <div className='bg-white w-full h-screen flex flex-col py-20 px-4 space-y-4'>
        ...
        <div className='space-y-2'>
          <div>
            ...
            <p className='text-custom-black text-md font-bold'>{jam_datang}</p>
          </div>
          <div>
